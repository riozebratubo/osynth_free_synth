...
void AdapterWindows::scan_start() {
    // SIMPLEBLE_LOG_INFO(fmt::format("WILL START SCAN!"));
    // fmt::print("WILL START SCAN!\n");
...
void AdapterWindows::scan_stop() {
    // SIMPLEBLE_LOG_ERROR(fmt::format("WILL STOP SCAN!"));
...
void AdapterWindows::_scan_stopped_callback() {
    ...
    // SIMPLEBLE_LOG_ERROR(fmt::format("SETTING SCAN STOPPED!"));
